...
public abstract class Parser implements Serializable{
	...
	// Returns the next document from the open file 
	Document nextDocument() throws NonInitializedParserException{
		try {
			long curOff=br.getFilePointer();
		}
		catch(Exception e){
			throw new NonInitializedParserException("NonInitializedParserException"); 
		}
	...
	abstract Document getDocument(String str) throws InvalidFormatDocumentException;
